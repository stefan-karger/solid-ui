export default function TypographyDemo() {
  return (
    <div>
      <h1 class="scroll-m-20 text-balance font-extrabold text-4xl tracking-tight">
      ...
      <h2 class="mt-10 scroll-m-20 border-b pb-2 font-semibold text-3xl tracking-tight transition-colors first:mt-0">
        The King&apos;s Plan
      </h2>
      <p class="leading-7 [&:not(:first-child)]:mt-6">
        The king thought long and hard, and finally came up with{" "}
        <a class="font-medium text-primary underline underline-offset-4" href="#">
          a brilliant plan
        </a>
      ...
      <h3 class="mt-8 scroll-m-20 font-semibold text-2xl tracking-tight">The Joke Tax</h3>
      <p class="leading-7 [&:not(:first-child)]:mt-6">
      ...
      <h3 class="mt-8 scroll-m-20 font-semibold text-2xl tracking-tight">Jokester&apos;s Revolt</h3>
      <p class="leading-7 [&:not(:first-child)]:mt-6">
      ...
      <h3 class="mt-8 scroll-m-20 font-semibold text-2xl tracking-tight">
