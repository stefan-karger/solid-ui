...
const NavigationMenuList = <T extends ValidComponent = "ul">(
  ...
  return (
    <div
      class={cn("cn-navigation-menu-list group flex list-none flex-1 items-center justify-center gap-1", local.class)}
...
const navigationMenuTriggerStyle = cva(
  "cn-navigation-menu-trigger group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium outline-hidden transition-[color,box-shadow] hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus-visible:ring-ring/50 focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[expanded]:bg-accent/50 data-[expanded]:hover:bg-accent data-[expanded]:text-accent-foreground data-[expanded]:focus:bg-accent"
)
  ...
  return (
    <div class={cn("absolute left-0 top-full isolate z-50 flex justify-center")}>
      <NavigationMenuPrimitive.Viewport
        class={cn(
          "cn-navigation-menu-viewport relative mt-1.5 h-[var(--kb-navigation-menu-viewport-height)] w-full origin-top-center overflow-hidden rounded-md border bg-popover text-popover-foreground shadow data-[closed]:animate-out data-[expanded]:animate-in data-[closed]:zoom-out-95 data-[expanded]:zoom-in-90 md:w-[var(--kb-navigation-menu-viewport-width)]",
          local.class
        )}
...
const NavigationMenuIndicator = <T extends ValidComponent = "div">(
  ...
  return (
    <NavigationMenuPrimitive.Arrow
      class={cn(
        "cn-navigation-menu-indicator relative top-[60%] z-[1] flex h-1.5 items-end justify-center overflow-hidden data-[closed]:animate-out data-[expanded]:animate-in data-[closed]:fade-out data-[expanded]:fade-in",
        local.class
      )}
