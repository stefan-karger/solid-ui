...
<ComponentPreview name="bubble-variants" previewClass="h-auto style-rhea" />
...
<ComponentPreview name="bubble-alignment" previewClass="h-auto style-rhea" />
...
<ComponentPreview name="bubble-group-demo" previewClass="h-auto style-rhea" />

### Links and Buttons

Turn a bubble into a link or button with the `as` prop on `BubbleContent`.

<ComponentPreview name="bubble-link-button" previewClass="h-auto style-rhea" />
...
<ComponentPreview name="bubble-reactions" previewClass="h-auto style-rhea" />
...
<ComponentPreview name="bubble-collapsible" previewClass="h-auto style-rhea" />
...
<ComponentPreview name="bubble-tooltip" previewClass="h-auto style-rhea" />
...
<ComponentPreview name="bubble-popover" previewClass="h-auto style-rhea" />
