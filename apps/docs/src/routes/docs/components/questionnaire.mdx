...
Define the collection once: pass it to `Questionnaire.Root` for progress, actions, and shortcuts,
...
`Questionnaire.Root` owns the ordered items, active item, answer state, validation, progress, and
