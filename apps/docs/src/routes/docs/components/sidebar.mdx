...
<ComponentPreview name="sidebar-floating-example" />

:::
:::tab[Code]

```file="~/registry/examples/sidebar-floating-example" frame=none showLineNumbers
...
<ComponentPreview name="sidebar-inset-example" />

:::
:::tab[Code]

```file="~/registry/examples/sidebar-inset-example" frame=none showLineNumbers
...
<ComponentPreview name="sidebar-icon-example" />

:::
:::tab[Code]

```file="~/registry/examples/sidebar-icon-example" frame=none showLineNumbers
