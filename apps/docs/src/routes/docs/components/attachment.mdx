...
```file="~/registry/examples/attachment-image" frame=none showLineNumbers
...
```file="~/registry/examples/attachment-state" frame=none showLineNumbers
...
```file="~/registry/examples/attachment-size" frame=none showLineNumbers
...
```file="~/registry/examples/attachment-group" frame=none showLineNumbers
...
```file="~/registry/examples/attachment-trigger" frame=none showLineNumbers
