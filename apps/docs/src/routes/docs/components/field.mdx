...
Field is a Solid composition helper that uses [Kobalte Label](https://kobalte.dev/docs/core/components/label) for accessible control labeling. Use the Field family to arrange labels, controls, descriptions, validation messages, and related controls.
...
<ComponentPreview name="field-checkbox" previewClass="h-[32rem]" />
...
<ComponentPreview name="field-group-example" previewClass="h-96" />
...
<ComponentPreview
  ...
  previewClass="h-[650px] p-6 md:h-[500px] md:p-10"
/>
...
For primitive label props and keyboard behavior, see the [Kobalte Label API reference](https://kobalte.dev/docs/core/components/label#api-reference).
