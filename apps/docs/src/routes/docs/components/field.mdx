...
```file="~/registry/new-york-v4/examples/field-input" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/field-textarea" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/field-select" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/field-slider" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/field-fieldset" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/field-checkbox" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/field-radio" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/field-switch" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/field-choice-card" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/field-group-example" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/field-responsive" frame=none showLineNumbers
