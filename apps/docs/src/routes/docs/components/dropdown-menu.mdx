...
```file="~/registry/new-york-v4/ui/dropdown-menu.tsx" showLineNumbers
...
```file="~/registry/new-york-v4/examples/dropdown-menu-checkboxes" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/dropdown-menu-radio-group" frame=none showLineNumbers
...
```file="~/registry/new-york-v4/examples/dropdown-menu-dialog" frame=none showLineNumbers
