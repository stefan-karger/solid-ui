...
export function DocsLayout(props: ParentProps) {
  ...
  return (
    <div class="container-wrapper flex flex-1 flex-col px-2">
      <SidebarProvider class="3xl:fixed:container min-h-min flex-1 items-start 3xl:fixed:px-3 px-0 [--sidebar-width:--spacing(72)] [--toc-width:--spacing(64)] [--top-spacing:0] has-data-[variant=inset]:bg-transparent lg:grid lg:grid-cols-[var(--sidebar-width)_minmax(0,1fr)] lg:[--top-spacing:--spacing(4)]">
        <MainNavigation />
        <div class="size-full">
