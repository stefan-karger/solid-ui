...
export function PageHeader(props: ComponentProps<"section">) {
  ...
  return (
    <section
      class={cn(
        "flex flex-col items-start gap-2 border-border/40 border-b px-4 py-8 md:py-12 md:pb-8 lg:py-12 lg:pb-10",
        local.class,
      )}
      {...others}
    >
...
export function PageHeaderDescription(props: ComponentProps<"p">) {
  ...
  return (
    <p
      class={cn("max-w-2xl font-light text-foreground text-lg", local.class)}
      {...others}
    />
  );
}
