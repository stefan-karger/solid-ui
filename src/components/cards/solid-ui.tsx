    ...
    <Card>
      <CardHeader class="grid grid-cols-[1fr_110px] items-start gap-4 space-y-0">
        ...
        <div class="flex items-center space-x-1 rounded-md bg-secondary text-secondary-foreground">
          <Button class="px-3 shadow-none" variant="secondary">
            <IconStar class="mr-2 size-4" />
            Star
          </Button>
          <Separator class="h-[20px]" orientation="vertical" />
          <DropdownMenu>
            <DropdownMenuTrigger
              as={Button<"button">}
            ...
            <DropdownMenuContent>
              <DropdownMenuGroup>
                ...
                <DropdownMenuRadioGroup defaultValue="future-ideas">
                  ...
                  <DropdownMenuRadioItem value="my-stack">
                    My Stack
                  </DropdownMenuRadioItem>
                  <DropdownMenuRadioItem value="inspiration">
                    Inspiration
                  </DropdownMenuRadioItem>
                </DropdownMenuRadioGroup>
              </DropdownMenuGroup>
      ...
      <CardContent>
        <div class="flex space-x-4 text-muted-foreground text-sm">
